      ...
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; -webkit-print-color-adjust: exact; }
          ...
          .title { font-size: 12px; font-weight: bold; margin-bottom: 2px; text-transform: uppercase; text-align: left; }
          .subtitle { font-size: 10px; margin-bottom: 4px; text-align: left; }
          .divider { border-top: 1px dashed #000; margin: 6px 0; width: 100%; }
          .room { font-size: 12px; font-weight: bold; margin: 6px 0; text-transform: uppercase; text-align: left; }
          .ticket { font-size: 40px; font-weight: 900; margin: 6px 0; line-height: 1; letter-spacing: 1px; text-align: left; }
          .footer { font-size: 9px; margin-top: 6px; font-weight: bold; text-align: left; }
        </style>
      </head>
      <body>
